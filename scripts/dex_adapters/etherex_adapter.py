#!/usr/bin/env python3
"""
Etherex (REX) DEX Adapter
Top DEX on Linea by users (68K) - LINEA/WETH pool configured
Pool: ETHEREX-LINEA-WETH-6600 (~2.86M liquidity)
"""
...
class EtherexAdapter(BaseDEXAdapter):
    """
    Etherex (REX) adapter
    Uniswap V3-style concentrated liquidity on Linea
    """
    ...
    def __init__(self, pool_address: str, rpc_url: str = None, w3: Optional[Web3] = None):
        ...
        # Load ABI (Etherex uses V3-compatible ABI)
    ...
    async def capture_snapshot(self) -> TickSnapshot:
        ...
        snapshot = TickSnapshot(
            ...
            metadata={
                ...
                "note": "ETHEREX-LINEA-WETH-6600 pool"
            }
        )
